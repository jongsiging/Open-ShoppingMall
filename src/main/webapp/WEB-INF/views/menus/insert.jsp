		...
		<div class="col-md-10">
			<div style="margin-top : 80px; margin-left: 30%;" class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
					<div class="col p-4 d-flex flex-column position-static">
						<p class="card-text mb-auto"><h4>메뉴 등록</h4></p>
						<form action="/menus/insert" method="post">
							<div class="input-group mb-2"> 
								<span class="input-group-text">menu_name</span>
								<input id="menu_name" name="menu_name" maxlength="30" style="width: 250px;">
							</div>
							<div class="input-group mb-2"> 
								<span class="input-group-text">menu_href</span>
								<input id="menu_href" name="menu_href" maxlength="30" style="width: 250px;">
							</div>
