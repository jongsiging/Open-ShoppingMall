...
<div class="container" style=" font-size : small;">
	<h4>상품 리스트</h4>
	<a class="btn btn-outline-primary btn-sm" style="float: right;" href="/seller/insertItem/${sellerLogin.seller_id}">상품등록</a>
	<table class="table">
		<thead>
			<tr>
				<th scope="col">no</th>
		...
		<tbody>
			<c:forEach items="${pt.list}" var="vo">
				<tr>
					...
					<td>
						<a class="btn btn-outline-primary btn-sm" href="/seller/addItem/${vo.item_no}">추가</a>
	...
	<jsp:include page="pageforlistItem.jsp" />
	</div>
</div>
