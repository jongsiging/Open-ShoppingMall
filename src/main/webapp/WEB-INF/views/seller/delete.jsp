...
<%-- 		<c:if test="${vo.seller_id == login.seller_id}"> --%>
			<div class="container" style="margin-left: 29%; margin-top: 100px; margin-bottom: 300px; width: 300px;">
				<form class="deletefrom" action="/seller/delete" id="deletefrom" method="post">
					<h1 class="h3 mb-3 font-weight-normal">회원탈퇴</h1>
					<hr>	
					<input readonly="readonly" class="form-control" name="seller_id" value="${vo.seller_id}"><br>
					<input type="password" id="seller_pw" name="seller_pw" class="form-control" placeholder="Password"><br>
