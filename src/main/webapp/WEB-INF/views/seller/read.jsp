		...
		<div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
			<div class="col p-4 d-flex flex-column position-static">
					...
					<div class="input-group mb-2">
						...
						<input readonly class="form-control" value="${vo.seller_id}">
					</div>
						
					<div class="input-group mb-2">
						<span class="input-group-text">이름</span> 
						<input readonly class="form-control" value="${vo.seller_name}">
					</div>						
						
					<div class="input-group mb-2">
						<span class="input-group-text">이메일</span> 
						<input readonly class="form-control" name="seller_email01" value="${vo.seller_email}">
						<input class="form-control" name="seller_email" id="seller_email" type="hidden">
					</div>					
						
					<div class="input-group mb-2">
						<span class="input-group-text">전화번호</span> 
						<input readonly class="form-control" value="${vo.seller_phone}" >
					</div>					
			</div>
		</div>		
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#read").click(function() {
			location.assign("/seller/update/${vo.seller_id}");
		});
		...
		$("#delete").click(function() {	
			...
			$("form").attr("action", "/seller/delete/${vo.seller_id}");
			$("form").submit();
		}); 
	});
</script>
